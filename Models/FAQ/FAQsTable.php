...
use ExpandableFAQ\Models\AbstractTable;
...
class FAQsTable extends AbstractTable implements TableInterface
{
    ...
    {
        parent::__construct($paramConf, $paramLang, $paramConf->getPrefix(), "faqs", $paramBlogId);
    }
    ...
    public function create()
    {
        ...
        $sqlQuery = "CREATE TABLE `{$validTablePrefix}{$validTableName}` (
          ...
          `faq_order` int(11) unsigned NOT NULL DEFAULT '0',
          `blog_id` int(11) unsigned NOT NULL DEFAULT '0',
          PRIMARY KEY (`faq_id`),
          KEY `faq_question` (`faq_question`(191)),
          KEY `faq_order` (`faq_order`),
          KEY `blog_id` (`blog_id`)
