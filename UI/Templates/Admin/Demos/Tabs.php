...
?>
<div class="expandable-faq-demos-admin expandable-faq-tabbed-admin expandable-faq-tabbed-admin-medium bg-cyan">
	<?php if ($errorMessage != ""): ?>
	...
	<div class="body">
		...
		<div class="modern-tabs modern-tabs-pos-top-left modern-tabs-anim-flip modern-tabs-response-to-icons">
            ...
            <label for="modern-tab1"><span><span><i class="fa fa-download" aria-hidden="true"></i><?=esc_html($lang['LANG_DEMOS_TEXT']);?></span></span></label>
