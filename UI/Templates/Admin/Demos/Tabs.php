...
?>
<div class="car-expandable-faq-demo-admin expandable-faq-tabbed-admin expandable-faq-tabbed-admin-medium bg-cyan">
	<?php if ($errorMessage != ""): ?>
	...
	<div class="body">
		...
		<div class="modern-tabs modern-tabs-pos-top-left modern-tabs-anim-flip modern-tabs-response-to-icons">
            <input type="radio" name="modern-tabs"<?=$demosTabChecked;?> id="modern-tab1" class="modern-tab-content-1">
